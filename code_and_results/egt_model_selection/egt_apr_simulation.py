...
def build_financiers(
    ...
    apr_gammas = expand_or_validate(apr_gammas or [0.85], financier_count, "APR gammas")
    ...
    financier_egt_etas = expand_or_validate(
        financier_egt_etas or [4.0], financier_count, "Financier EGT etas"
    )
    borrower_alphas = expand_or_validate(borrower_alphas or [0.25], financier_count, "Borrower RL alphas")
    ...
    borrower_premium_action_sets = expand_or_validate(
        borrower_premium_action_sets or [(-2.0, 0.0, 2.0, 4.0, 8.0, 12.0, 16.0)],
        financier_count,
        "Borrower premium action sets",
    )

    pure_rl_apr_action_sets = expand_or_validate(
        pure_rl_apr_action_sets or [(6.0, 8.0, 10.0, 12.0, 14.0, 16.0, 18.0, 20.0, 24.0, 30.0, 36.0)],
        financier_count,
    ...
    max_offer_apr = 1_000_000.0 if uncapped_apr else 48.0
